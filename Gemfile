...
gem 'rubyzip',             '~> 1.3.0', # Zip and encrypt exported files
    require: 'zip'
gem 'rufus-scheduler', '~> 3.5', '>= 3.5.2' # Primero, Rails-context job cron-like scheduling.
    require: false
...
gem 'twitter_cldr', '~> 4.4', '>= 4.4.4' # Localization for dates, money. TODO: Is this still used?
gem 'tzinfo', '~> 1.2', '>= 1.2.10' # Security assertion on implicit dependency.
gem 'tzinfo-data', '~> 1.2019', '>= 1.2019.3' # Security assertion on implicit dependency.
...
group :development, :test do
  ...
  gem 'rspec',                      '~> 3.8'
  gem 'rspec-activemodel-mocks', '~> 1.1', '>= 1.1.0'
