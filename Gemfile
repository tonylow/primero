...
gem 'nokogiri', '>= 1.15.6' # Security assertion on implicit dependency.
...
gem 'rack', '>= 2.2.8.1'
gem 'rack-attack', '>= 6.4.0' # Rack middleware to rate limit sensetive routes, such as those used for auth
gem 'rails', '7.0.8.1'
gem 'rake',                '~> 12.3'
